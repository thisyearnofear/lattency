...
import { cafePhotoUrl } from "./cafe-photos";
...
export const MOCK_CAFES: CafeStation[] = [
  ...
  // Shoreditch High Street / Old Street
  {
    ...
    medianLossPct: 0,
    measurementCount: 6,
    latestPhotoUrl: cafePhotoUrl("ozone-ldn"),
    venueType: "cafe",
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 4,
    latestPhotoUrl: cafePhotoUrl("prufrock-ldn"),
    venueType: "cafe",
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 5,
    latestPhotoUrl: cafePhotoUrl("allpress-ldn"),
    venueType: "cafe",
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 8,
    latestPhotoUrl: cafePhotoUrl("wework-oldstreet"),
    venueType: "coworking",
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 4,
    latestPhotoUrl: cafePhotoUrl("hoxton-lobby"),
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 3,
    latestPhotoUrl: cafePhotoUrl("shoreditch-grind"),
    venueType: "cafe",
    vibe: "buzzy corner",
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 5,
    latestPhotoUrl: cafePhotoUrl("climpson-ldn"),
    venueType: "cafe",
    vibe: "broadway market institution",
    vibeTags: ["garden", "brunch", "outlets++"],
    city: "london",
    metadata: {
      priceTier: "mid",
      milkOptions: ["dairy", "oat", "soy"],
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 4,
    latestPhotoUrl: cafePhotoUrl("lmnh-ldn"),
    venueType: "cafe",
    vibe: "cycle workshop + flat whites",
    vibeTags: ["fibre", "outlets++", "brunch"],
    city: "london",
    metadata: {
      priceTier: "mid",
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 7,
    latestPhotoUrl: cafePhotoUrl("secondhome-ldn"),
    venueType: "coworking",
    vibe: "creative coworking hub",
    vibeTags: ["fibre", "outlets++", "meeting-rooms"],
    city: "london",
    metadata: {
      priceTier: "premium",
    ...
    sponsor: {
      ...
      kind: "isp",
      tagline: "2 Gbps symmetric on-site",
    },
  },
  ...
  // Westlands
  {
    ...
    medianLossPct: 0,
    measurementCount: 4,
    latestPhotoUrl: cafePhotoUrl("sarit-b"),
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 4,
    latestPhotoUrl: cafePhotoUrl("westgate-b"),
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 4,
    latestPhotoUrl: cafePhotoUrl("connect-b"),
  ...
  // Kilimani
  {
    ...
    medianLossPct: 0,
    measurementCount: 4,
    latestPhotoUrl: cafePhotoUrl("kaldi-b"),
    vibe: "yaya regulars",
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 4,
    latestPhotoUrl: cafePhotoUrl("brew-a"),
    vibe: "loud at lunch",
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 4,
    latestPhotoUrl: cafePhotoUrl("thyme-b"),
    vibe: "fibre + filter",
  ...
  // CBD
  {
    ...
    medianLossPct: 0,
    measurementCount: 4,
    latestPhotoUrl: cafePhotoUrl("mamangina-b"),
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 4,
    latestPhotoUrl: cafePhotoUrl("savanna-b"),
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 4,
    latestPhotoUrl: cafePhotoUrl("dormans-a"),
  ...
  // Karen
  {
    ...
    medianLossPct: 0,
    measurementCount: 4,
    latestPhotoUrl: cafePhotoUrl("talisman-b"),
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 4,
    latestPhotoUrl: cafePhotoUrl("blixen-b"),
    vibe: "the book-wifi",
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 4,
    latestPhotoUrl: cafePhotoUrl("hub-b"),
    vibe: "mall route",
  ...
  // SOMA / FiDi
  {
    ...
    medianLossPct: 0,
    measurementCount: 0,
    latestPhotoUrl: cafePhotoUrl("sightglass"),
    vibe: "the glassworks",
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 0,
    latestPhotoUrl: cafePhotoUrl("mazarine"),
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 0,
    latestPhotoUrl: cafePhotoUrl("bluebottle-mint"),
  ...
  // Mission
  {
    ...
    medianLossPct: 0,
    measurementCount: 0,
    latestPhotoUrl: cafePhotoUrl("ritual-mission"),
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 0,
    latestPhotoUrl: cafePhotoUrl("verve-mission"),
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 0,
    latestPhotoUrl: cafePhotoUrl("linea"),
  ...
  // Russian Hill / Hayes
  {
    ...
    medianLossPct: 0,
    measurementCount: 0,
    latestPhotoUrl: cafePhotoUrl("saintfrank"),
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 0,
    latestPhotoUrl: cafePhotoUrl("reveille-hayes"),
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 0,
    latestPhotoUrl: cafePhotoUrl("coffee-movement"),
    vibe: "nob hill pour",
  ...
  // Marina / Outer
  {
    ...
    medianLossPct: 0,
    measurementCount: 0,
    latestPhotoUrl: cafePhotoUrl("wreckingball"),
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 0,
    latestPhotoUrl: cafePhotoUrl("themill"),
  ...
  },
  {
    ...
    medianLossPct: 0,
    measurementCount: 0,
    latestPhotoUrl: cafePhotoUrl("andytown"),
    vibe: "ocean fog brew",
